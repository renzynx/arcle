...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@arcle/ui/components/sheet";
...
import { useIsMobile } from "@arcle/ui/hooks/use-mobile";
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: shadcn/ui pattern for persisting sidebar state
